...
public:
	...
	virtual IT4GameObject* GetMouseOverGameObject() override { return nullptr; }
...
public:
	...
	void HandleOnGameWorldTravelPre(IT4GameWorld* InGameWorld); // #87 : 월드 이동 playback 지원
	void HandleOnGameWorldTravelPost(IT4GameWorld* InGameWorld); // #87 : 월드 이동 playback 지원
