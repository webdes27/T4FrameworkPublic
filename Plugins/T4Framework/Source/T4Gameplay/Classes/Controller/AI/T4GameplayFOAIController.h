 ...
 */
UCLASS()
class T4GAMEPLAY_API AT4GameplayFOAIController : public AT4GameAIController
{
...
public:
	...
	FName GetClassTypeName() const override { return DefaultFOClassName; } // #104 : Object type 을 Enum 이 아니라 FName 으로 처리. N개가 될 수 있음을 가정하겠음
