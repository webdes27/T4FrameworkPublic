...
#if WITH_EDITOR
	const FT4GameDataInfo& GetGameDataInfo(ET4GameDataType InGameDataType);
#endif
...
#if WITH_EDITOR
	void HandleOnGameTableChanged(ET4GameDataType InGameTableType);

	template <class T, class U>
	bool CopyDataFromRawInternal(
...
private:
	...
	FT4GameDataInfo GameDataInfos[uint8(ET4GameDataType::Nums)]; // #27, #66

#if WITH_EDITOR
	FT4GameDataInfo EmptyDatas; // #60
#endif
};
