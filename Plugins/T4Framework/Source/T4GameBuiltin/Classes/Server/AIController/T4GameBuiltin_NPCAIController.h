...
struct FT4NPCAIMemory // #50
{
	...
	void Reset()
	{
		AIState = ET4GameplayAIState::Invisible;
...
class IT4WorldActor;
UCLASS()
class T4GAMEBUILTIN_API AT4GameBuiltin_NPCAIController : public AT4GameAIController
{
	GENERATED_UCLASS_BODY()

public:
	// class IT4ObjectController
	FName GetClassTypeName() const override { return DefaultNPCClassName; } // #104 : Object type 을 Enum 이 아니라 FName 으로 처리. N개가 될 수 있음을 가정하겠음

	void OnNotifyAIEvent(const FName& InEventName, const FT4ObjectID& InSenderObjectID) override; // #63

	// IT4GameAIController
	ET4GameplayTribeType GetTribeType() const override; // #104 : TODO
	ET4GameplayEnemyType GetEnemyType() const override; // #104 : TODO

public:
	bool Bind(const FT4GameBuiltin_GameDataID& InNPCGameDataID); // #31, #50

	bool IsDead() const { return (ET4GameplayAIState::Dead == AIMemory.AIState) ? true : false; } // #114
