...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FT4ActionControlCompositeTest, "T4Engine.Action.RootComposite", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FT4ActionControlCompositeTest::RunTest(const FString& Parameters)
{
	FT4ActionControl* NewActionRoot = new FT4ActionControl();
	...
	for (;;)
	{
		...
		FT4ActionNode* NewActionNode = NewActionRoot->CreateNode(&NewParentAction, nullptr);
