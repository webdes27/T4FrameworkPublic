...
#include "T4Asset/Public/Action/T4ActionContiCommands.h"
...
class FT4ActionNodeBase : public IT4ActionNode
{
public:
	explicit FT4ActionNodeBase(FT4ActionNodeControl* InControl, const FT4ActionKey& InKey);
	virtual ~FT4ActionNodeBase();
	...
	IT4ActionNode* AddChildNode(const FT4ActionCommand* InAction, float InOffsetTimeSec) override; // #23, #54
...
public:
	...
	static FT4ActionNodeBase* CreateNode(
	...
	static void DestroyNode(FT4ActionNodeBase** InActionNode);

	bool OnCreate(const FT4ActionCommand* InAction);
	void OnDestroy();
	...
	void SetParentNode(FT4ActionNodeBase* InParentNode) { ParentNode = InParentNode; }
	...
	bool AddChildNodeInternal(const FT4ActionCommand* InAction, FT4ActionNodeBase* InActionNode); // #23

protected:
	virtual bool Create(const FT4ActionCommand* InAction) { return true; }
...
protected:
	...
	FT4ActionNodeControl* ActionControlRef;
	IT4ActionNode* ParentNode; // #23
	FT4ActionNodeBaseGraph ActionNodeGraph; // #23
