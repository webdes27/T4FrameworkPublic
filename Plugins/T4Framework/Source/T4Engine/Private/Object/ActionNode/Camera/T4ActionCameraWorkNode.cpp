...
/**
  * #58
 */
FT4ActionCameraWorkNode::FT4ActionCameraWorkNode(FT4ActionNodeControl* InControl, const FT4ActionKey& InKey)
...
bool FT4ActionCameraWorkNode::Create(const FT4ActionCommand* InAction)
{
	check(ET4ActionType::CameraWork == InAction->ActionType);
...
void FT4ActionCameraWorkNode::Advance(const FT4UpdateTime& InUpdateTime)
{
	...
	{
		LocalBlendWeight = T4EngineEnvironment::Evaluate(
