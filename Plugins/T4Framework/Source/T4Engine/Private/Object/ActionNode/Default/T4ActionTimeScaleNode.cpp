...
/**
  * #102
 */
FT4ActionTimeScaleNode::FT4ActionTimeScaleNode(FT4ActionNodeControl* InControl, const FT4ActionKey& InKey)
...
bool FT4ActionTimeScaleNode::Create(const FT4ActionCommand* InAction)
{
	check(ET4ActionType::TimeScale == InAction->ActionType);
