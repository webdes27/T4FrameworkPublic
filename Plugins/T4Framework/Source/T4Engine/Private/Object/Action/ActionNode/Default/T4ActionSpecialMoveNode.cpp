...
/**
  *
 */
FT4ActionSpecialMoveNode::FT4ActionSpecialMoveNode(FT4ActionControl* InControl, const FT4ActionKey& InKey)
...
bool FT4ActionSpecialMoveNode::Create(const FT4ActionStruct* InAction)
{
	check(ET4ActionType::SpecialMove == InAction->ActionType);
