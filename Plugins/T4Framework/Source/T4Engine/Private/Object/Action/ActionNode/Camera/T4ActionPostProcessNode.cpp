...
/**
  * #100
 */
FT4ActionPostProcessNode::FT4ActionPostProcessNode(FT4ActionControl* InControl, const FT4ActionKey& InKey)
...
bool FT4ActionPostProcessNode::Create(const FT4ActionStruct* InAction)
{
	check(ET4ActionType::PostProcess == InAction->ActionType);
	...
	check(OwnerGameObject->IsPlayer()); // PP 는 플레이어만 동작한다!!
