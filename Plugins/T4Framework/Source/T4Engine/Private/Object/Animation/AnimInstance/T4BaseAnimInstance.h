...
public:
	...
	virtual FT4StateAnimVariables* GetStateAnimVariables() { return nullptr; }
	...
	bool HasSection(const FName& InAnimMontageName, const FName& InSectionName);
	float GetDurationSec(const FName& InAnimMontageName, const FName& InSectionName);

	bool IsPlaying(const FName& InAnimMontageName); // #116
