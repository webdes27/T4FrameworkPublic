...
public:
	...
	bool IsValidSection(const FName& InAnimMontageName, const FName& InSectionName) override;
...
public:
	static FT4BaseAnimControl* CreateNewControl(
	...
	AT4GameObject* GetGameObject() { return GameObject.Get(); }
...
protected:
	...
	bool bBegunPlay;
	TWeakObjectPtr<AT4GameObject> GameObject;
