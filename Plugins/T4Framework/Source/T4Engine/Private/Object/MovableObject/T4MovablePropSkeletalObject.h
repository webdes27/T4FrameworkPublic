...
#include "T4MovablePropSkeletalObject.generated.h"
...
public:
	ET4ObjectType GetObjectType() const override { return ET4ObjectType::Entity_PropSkeletal; }
