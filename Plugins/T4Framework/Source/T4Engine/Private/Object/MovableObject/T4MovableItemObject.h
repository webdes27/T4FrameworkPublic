...
class UT4ParticleSystemComponent; // #110
...
public:
	...
	UPROPERTY(Category=Item, VisibleAnywhere)
	UT4ParticleSystemComponent* ParticleSystemComponent; // #110
...
private:
	...
	FT4ParticleSystemLoader ParticleSystemLoader; // #110
