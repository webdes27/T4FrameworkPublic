...
/**
  * #68
 */
class FT4ActionPlaybackPlayer : public FT4ActionPlaybackBase, public IT4ActionPlaybackPlayer
{
public:
	explicit FT4ActionPlaybackPlayer(ET4LayerType InLayerType, bool bInRepeat, bool bInPlayerPossessed);
	virtual ~FT4ActionPlaybackPlayer();
