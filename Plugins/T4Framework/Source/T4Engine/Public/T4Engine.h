...
// #34, #63
class T4ENGINE_API IT4ObjectController
{
public:
	...
	virtual bool HasPlayerController() const = 0; // #104
...
public:
	...
	virtual IT4ObjectController* GetObjectController() = 0; // #34, #42, #36
	virtual void SetObjectController(IT4ObjectController* InControl) = 0; // #34, #42, #36
...
public:
	...
	virtual bool DoPlay(const FString& InPlayAssetName, const FString& InFolderName) = 0; // /T4Framework/Editor/ActionPlayback/<InFolderName>/<InPlayAssetName>.uasset
	...
	virtual bool DoRec(const FString& InRecAssetName, const FString& InFolderName) = 0; // /T4Framework/Editor/ActionPlayback/<InFolderName>/<InRecAssetName>.uasset
...
public:
	...
	virtual IT4ObjectController* GetPlayerControl() = 0;
	virtual bool SetPlayerControl(IT4ObjectController* InPlayerControl) = 0;
