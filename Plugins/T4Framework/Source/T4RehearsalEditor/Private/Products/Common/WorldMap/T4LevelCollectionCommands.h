...
#define LOCTEXT_NAMESPACE "T4LevelCollectionCommands"

/** The set of commands supported by the WorldView */
class FT4LevelCollectionCommands 
	: public TCommands<FT4LevelCollectionCommands>
{

public:

	/** FT4LevelCollectionCommands Constructor */
	FT4LevelCollectionCommands() 
		: TCommands<FT4LevelCollectionCommands>
	(
		"WorldMap", // Context name for fast lookup
		NSLOCTEXT("Contexts", "WorldMap", "World Map"), // Localized context name for displaying
		NAME_None, // Parent
	...
	virtual void RegisterCommands() override
	{
		...
		UI_COMMAND( PreviewWorld_LoadLevel, "Load", "Load selected level into Preview world", EUserInterfaceActionType::Button, FInputChord()); // #104
		UI_COMMAND( PreviewWorld_UnloadLevel, "Unload", "Unload selected level from Preview world", EUserInterfaceActionType::Button, FInputChord()); // #104
		...
		// #84
		UI_COMMAND( World_ThumbnailSelectedLevels, "Update Thumbnail", "Update Thumbnail selected levels", EUserInterfaceActionType::Button, FInputChord());
		...
		UI_COMMAND( World_CameraLookAtLocation, "Look At", "Editor Camera Look At Location", EUserInterfaceActionType::Button, FInputChord());
...
public:
	...
	TSharedPtr< FUICommandInfo > World_ThumbnailSelectedLevels; // #84

	TSharedPtr< FUICommandInfo > PreviewWorld_CameraLookAtLocation; // #90
	TSharedPtr< FUICommandInfo > World_CameraLookAtLocation; // #90
	...
	/** Load level to the Preview world */
	TSharedPtr< FUICommandInfo > PreviewWorld_LoadLevel; // #104

	/** Unload level from the Preview world */
	TSharedPtr< FUICommandInfo > PreviewWorld_UnloadLevel; // #104
};
