...
#include "T4WorldTileDetails.generated.h"
...
// 
UCLASS()
class UT4WorldTileDetails : public UObject
{
	...
	FT4TileLODEntryDetails			LOD1;

	UPROPERTY(Category=LODSettings, EditAnywhere)
	FT4TileLODEntryDetails			LOD2;

	UPROPERTY(Category=LODSettings, EditAnywhere)
	FT4TileLODEntryDetails			LOD3;

	UPROPERTY(Category=LODSettings, EditAnywhere)
	FT4TileLODEntryDetails			LOD4;
	...
	DECLARE_EVENT( UT4WorldTileDetails, FTilePropertyChanged )
