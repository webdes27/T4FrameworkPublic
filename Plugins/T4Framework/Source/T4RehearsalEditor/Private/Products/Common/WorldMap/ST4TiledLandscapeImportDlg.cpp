...
void ST4TiledLandcapeImportDlg::Construct(const FArguments& InArgs, TSharedPtr<SWindow> InParentWindow)
{
	bShouldImport = false;
		...
		[
			...
			[
				...
				[
					...
					.OnClicked(this, &ST4TiledLandcapeImportDlg::OnClickedSelectHeightmapTiles)
				...
				[
					SNew(SCheckBox)
					.IsChecked(this, &ST4TiledLandcapeImportDlg::GetFlipYAxisState)
					.OnCheckStateChanged(this, &ST4TiledLandcapeImportDlg::OnFlipYAxisStateChanged)
				...
				[
					...
					[
						...
						.Value(this, &ST4TiledLandcapeImportDlg::GetTileOffsetX)
						.OnValueChanged(this, &ST4TiledLandcapeImportDlg::SetTileOffsetX)
						.LabelPadding(0)
						.Label()
						[
					...
					[
						SNew(SNumericEntryBox<int32>)
						.Value(this, &ST4TiledLandcapeImportDlg::GetTileOffsetY)
						.OnValueChanged(this, &ST4TiledLandcapeImportDlg::SetTileOffsetY)
						.LabelPadding(0)
						.Label()
						[
				...
				[
					...
					.OnSelectionChanged(this, &ST4TiledLandcapeImportDlg::OnSetImportConfiguration)
					.OnGenerateWidget(this, &ST4TiledLandcapeImportDlg::HandleTileConfigurationComboBoxGenarateWidget)
					.Content()
					[
						SNew(STextBlock)
						.Text(this, &ST4TiledLandcapeImportDlg::GetTileConfigurationText)
					]
				]
				...
				[
					...
					.X( this, &ST4TiledLandcapeImportDlg::GetScaleX )
					.Y( this, &ST4TiledLandcapeImportDlg::GetScaleY )
					.Z( this, &ST4TiledLandcapeImportDlg::GetScaleZ )
					.OnXCommitted( this, &ST4TiledLandcapeImportDlg::OnSetScale, 0 )
					.OnYCommitted( this, &ST4TiledLandcapeImportDlg::OnSetScale, 1 )
					.OnZCommitted( this, &ST4TiledLandcapeImportDlg::OnSetScale, 2 )
				]
				...
				[
					...
					.ObjectPath(this, &ST4TiledLandcapeImportDlg::GetLandscapeMaterialPath)
					.OnObjectChanged(this, &ST4TiledLandcapeImportDlg::OnLandscapeMaterialChanged)
					.AllowClear(true)
				]
			]
			...
			[
				SAssignNew(LayerDataListView, SListView<TSharedPtr<FT4TiledLandscapeImportSettings::LandscapeLayerSettings>>)
				.ListItemsSource( &LayerDataList )
				.OnGenerateRow( this, &ST4TiledLandcapeImportDlg::OnGenerateWidgetForLayerDataListView )
			...
			[
				SNew(STextBlock)
				.Text(this, &ST4TiledLandcapeImportDlg::GetImportSummaryText)
				.WrapTextAt(600.0f)
			]
			...
			[
				...
				[
					...
					.HAlign(HAlign_Center)
					.ContentPadding(FEditorStyle::GetMargin("StandardDialog.ContentPadding"))
					.IsEnabled(this, &ST4TiledLandcapeImportDlg::IsImportEnabled)
					.OnClicked(this, &ST4TiledLandcapeImportDlg::OnClickedImport)
				...
				[
					...
					.HAlign(HAlign_Center)
					.ContentPadding(FEditorStyle::GetMargin("StandardDialog.ContentPadding"))
					.OnClicked(this, &ST4TiledLandcapeImportDlg::OnClickedCancel)
...
TSharedRef<SWidget> ST4TiledLandcapeImportDlg::HandleTileConfigurationComboBoxGenarateWidget(TSharedPtr<FTileImportConfiguration> InItem) const
{
...
FText ST4TiledLandcapeImportDlg::GetTileConfigurationText() const
{
...
TSharedRef<ITableRow> ST4TiledLandcapeImportDlg::OnGenerateWidgetForLayerDataListView(
	TSharedPtr<FT4TiledLandscapeImportSettings::LandscapeLayerSettings> InLayerData, 
	const TSharedRef<STableViewBase>& OwnerTable)
{
	return 	SNew(STableRow<TSharedRef<FT4TiledLandscapeImportSettings::LandscapeLayerSettings>>, OwnerTable)
			[
				SNew(SBorder)
				[
					SNew(SHorizontalBox)
					...
					[
						SNew(SCheckBox)
						.IsChecked(this, &ST4TiledLandcapeImportDlg::GetLayerBlendState, InLayerData)
						.OnCheckStateChanged(this, &ST4TiledLandcapeImportDlg::OnLayerBlendStateChanged, InLayerData)
					...
					.AutoWidth()
					[
						SNew(STextBlock).Text(this, &ST4TiledLandcapeImportDlg::GetWeightmapCountText, InLayerData)
					]
					...
					[
						...
						.HAlign(HAlign_Center)
						.ContentPadding(FEditorStyle::GetMargin("StandardDialog.ContentPadding"))
						.OnClicked(this, &ST4TiledLandcapeImportDlg::OnClickedSelectWeightmapTiles, InLayerData)
...
bool ST4TiledLandcapeImportDlg::ShouldImport() const
{
	return bShouldImport;
}

const FT4TiledLandscapeImportSettings& ST4TiledLandcapeImportDlg::GetImportSettings() const
{
	return ImportSettings;
}

TOptional<float> ST4TiledLandcapeImportDlg::GetScaleX() const
{
	return ImportSettings.Scale3D.X;
}

TOptional<float> ST4TiledLandcapeImportDlg::GetScaleY() const
{
	return ImportSettings.Scale3D.Y;
}

TOptional<float> ST4TiledLandcapeImportDlg::GetScaleZ() const
{
	return ImportSettings.Scale3D.Z;
}

void ST4TiledLandcapeImportDlg::OnSetScale(float InValue, ETextCommit::Type CommitType, int32 InAxis)
{
...
TOptional<int32> ST4TiledLandcapeImportDlg::GetTileOffsetX() const
{
	return ImportSettings.TilesCoordinatesOffset.X;
}

void ST4TiledLandcapeImportDlg::SetTileOffsetX(int32 InValue)
{
	ImportSettings.TilesCoordinatesOffset.X = InValue;
}

TOptional<int32> ST4TiledLandcapeImportDlg::GetTileOffsetY() const
{
	return ImportSettings.TilesCoordinatesOffset.Y;
}

void ST4TiledLandcapeImportDlg::SetTileOffsetY(int32 InValue)
{
	ImportSettings.TilesCoordinatesOffset.Y = InValue;
}

ECheckBoxState ST4TiledLandcapeImportDlg::GetFlipYAxisState() const
{
	return ImportSettings.bFlipYAxis ? ECheckBoxState::Checked : ECheckBoxState::Unchecked;
}

void ST4TiledLandcapeImportDlg::OnFlipYAxisStateChanged(ECheckBoxState NewState)
{
	ImportSettings.bFlipYAxis = (NewState == ECheckBoxState::Checked);
}

void ST4TiledLandcapeImportDlg::OnSetImportConfiguration(TSharedPtr<FTileImportConfiguration> InTileConfig, ESelectInfo::Type SelectInfo)
{
...
FReply ST4TiledLandcapeImportDlg::OnClickedSelectHeightmapTiles()
{
...
FReply ST4TiledLandcapeImportDlg::OnClickedSelectWeightmapTiles(TSharedPtr<FT4TiledLandscapeImportSettings::LandscapeLayerSettings> InLayerData)
{
...
bool ST4TiledLandcapeImportDlg::IsImportEnabled() const
{
	return ImportSettings.HeightmapFileList.Num() && ImportSettings.ComponentsNum > 0;
}

FReply ST4TiledLandcapeImportDlg::OnClickedImport()
{
...
FReply ST4TiledLandcapeImportDlg::OnClickedCancel()
{
	ParentWindow->RequestDestroyWindow();
	bShouldImport = false;
...
FString ST4TiledLandcapeImportDlg::GetLandscapeMaterialPath() const
{
	return ImportSettings.LandscapeMaterial.IsValid() ? ImportSettings.LandscapeMaterial->GetPathName() : FString("");
}

void ST4TiledLandcapeImportDlg::OnLandscapeMaterialChanged(const FAssetData& AssetData)
{
...
int32 ST4TiledLandcapeImportDlg::SetPossibleConfigurationsForFileWidth(int64 TargetFileWidth)
{
...
void ST4TiledLandcapeImportDlg::GenerateAllPossibleTileConfigurations()
{
...
FText ST4TiledLandcapeImportDlg::GetImportSummaryText() const
{
...
FText ST4TiledLandcapeImportDlg::GetWeightmapCountText(TSharedPtr<FT4TiledLandscapeImportSettings::LandscapeLayerSettings> InLayerData) const
{
	int32 NumWeighmaps = InLayerData.IsValid() ? InLayerData->WeightmapFiles.Num() : 0;
	return FText::AsNumber(NumWeighmaps);
}

ECheckBoxState ST4TiledLandcapeImportDlg::GetLayerBlendState(TSharedPtr<FT4TiledLandscapeImportSettings::LandscapeLayerSettings> InLayerData) const
{
	return (InLayerData->bNoBlendWeight ? ECheckBoxState::Unchecked : ECheckBoxState::Checked);
}

void ST4TiledLandcapeImportDlg::OnLayerBlendStateChanged(ECheckBoxState NewState, TSharedPtr<FT4TiledLandscapeImportSettings::LandscapeLayerSettings> InLayerData)
{
	InLayerData->bNoBlendWeight = !(NewState == ECheckBoxState::Checked);
}

FText ST4TiledLandcapeImportDlg::GenerateConfigurationText(int32 NumComponents, int32 NumSectionsPerComponent, int32 NumQuadsPerSection) const
{
...
void ST4TiledLandcapeImportDlg::UpdateLandscapeLayerList()
{
	...
	for (FName LayerName : LayerNamesList)
	{
		...
		TSharedPtr<FT4TiledLandscapeImportSettings::LandscapeLayerSettings> LayerData = MakeShareable(new FT4TiledLandscapeImportSettings::LandscapeLayerSettings());
