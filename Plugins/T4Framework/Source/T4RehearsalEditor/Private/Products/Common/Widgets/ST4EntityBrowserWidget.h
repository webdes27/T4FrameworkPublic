...
class ST4EntityBrowserWidget : public SCompoundWidget
{
public:
	...
	DECLARE_DELEGATE(FT4OnSavePreviewCameraInfo);
...
public:
	SLATE_BEGIN_ARGS(ST4EntityBrowserWidget) {}
		...
		SLATE_ARGUMENT(FT4OnSavePreviewCameraInfo, OnSavePreviewCameraInfo)
...
public:
	...
	void HandleOnThumbnailSelectedAssets(TArray<FAssetData> InObjects) const;
	bool HandleCanThumbnailSelectedAssets(TArray<FAssetData> InObjects) const;

	void HandleOnSavePreviewCameraInfoSelectedAssets(TArray<FAssetData> InObjects) const;
	bool HandleCanSavePreviewCameraInfoSelectedAssets(TArray<FAssetData> InObjects) const;
...
protected:
	...
	FT4OnSavePreviewCameraInfo OnSavePreviewCameraInfo;
