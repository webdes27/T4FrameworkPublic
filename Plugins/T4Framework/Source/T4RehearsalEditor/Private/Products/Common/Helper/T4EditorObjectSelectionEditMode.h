...
class IT4RehearsalViewModel; // #94

class FT4EditorObjectSelectionEditMode : public FEdMode
{
public:
...
public:
	void SetViewModel(IT4RehearsalViewModel* InViewModel) { ViewModelRef = InViewModel; } // #94
