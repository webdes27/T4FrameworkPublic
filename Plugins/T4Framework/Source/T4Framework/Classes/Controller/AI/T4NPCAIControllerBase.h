...
#include "T4NPCAIControllerBase.generated.h"
...
class UT4PathFollowingComponentBase;

UCLASS()
class T4FRAMEWORK_API AT4NPCAIControllerBase : public AAIController, public IT4NPCAIControllerBase
{
...
protected:
	...
	UPROPERTY(transient)
	UT4PathFollowingComponentBase* OverridePathFollowingComponent; // #34
};
